...
While the distance metric implementation can be improved we 1need to keep it 
sensitive as this is a drawback to its speed. We also plan to investigate 
alternative methods to locate centroid candidates as the current 
implementation does not provide good results.
